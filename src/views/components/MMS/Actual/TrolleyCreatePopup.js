...
const TrolleyCreatePopup = memo(
  ({ woId, materialId, materialCode, isShowing, onClose, refreshLotDataGrid, getWoInfo }) => {
    const intl = useIntl();
    ...
    const { handleChange, handleBlur, handleSubmit, values, setFieldValue, errors, touched, isValid, resetForm } =
      formik;
