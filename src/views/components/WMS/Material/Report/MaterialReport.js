...
const MaterialReport = (props) => {
  ...
  async function fetchData() {
    if (
      ...
      (iqcState.searchData.searchEndDay != null && iqcState.searchData.searchEndDay!="")
    ) {
    ...
    const res = await materialReportService.getReport(params);
  ...
  const handleDownload = async() =>{
    try {
        const params = {
          ...
          await materialReportService.downloadReport(params);
    }
    catch (error) {
  ...
  return (
    <React.Fragment>
      ...
      />
      <MaterialReportDetail LotId={LotId}/>
    </React.Fragment>
  );
};
...
export default connect(mapStateToProps, mapDispatchToProps)(MaterialReport);
