...
(function ($, document) {
	...
	$.ui.fancytree.prototype.detroymenu = function() {
		var tree = this.tree;
		$.contextMenu("destroy", "." + (tree.options.contextMenu.selector || "fancytree-title"));
	};
	...
	$.ui.fancytree.registerExtension({
		...
		treeDestroy: function(ctx) {
			...
			$.contextMenu("destroy", "." + (ctx.options.contextMenu.selector || "fancytree-title"));
